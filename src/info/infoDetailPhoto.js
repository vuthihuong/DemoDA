...
import iconInfo from './imgInfo/iconInfo.png'
import like from './../img/heart.png'
import comment from './../img/comment.png'
import iconGender from './imgInfo/gender.png'
import dateBirth from './imgInfo/icon_date_birth.png'
import address from './imgInfo/imgLocation.png'
import photoIcon from './../img/photoDetail.png'
import right from './../img/iconRight.png'
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.bodyDetailPhoto}>
                    ...
                    <View style ={styles.textBody}>
                        <Image source={address} style={{width: 15, height: 20, tintColor: '#1E90FF',
